          ...
          <div class="tab-1 tab-content content_extab current">
            <div class="getcontent">
              ...
              <p>Thông tin sản phẩm: <br>
                ...
                - Thiết kế: Thêu</p>
              <p>
                <img src="../img/item/f1.jpg" alt="" height="650px" width="650px">
                <br><br><br><br>
                Về C L O S E T: <br>
...
- Sản phẩm còn mới nguyên tem, tags và mang theo hoá đơn mua hàng, sản phẩm chưa giặt và không dơ bẩn, hư hỏng bởi những tác nhân bên ngoài cửa hàng sau khi mua hàng.
        ...
        <div class="col-12 col-lg-8">
          <div id="targetselection">
            <div id="product-review" style="margin: auto; ">
              <div class="content" style="text-align: center;padding: 25px 0;">
                ...
                <div class="box-user">
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nhập họ tên">
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nhập số điện thoại">
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Nhập Email">
                    <input type="text" class="form-control" id="formGroupExampleInput" placeholder="Đánh giá của bạn dành cho chúng tôi">
                </div>
        ...
        <div class="col-12">
            <div class="chat1">
                ...
                <div class="content">
                    <div class="user-chat">awdadsadasd</div>
                    <div class="commits">
